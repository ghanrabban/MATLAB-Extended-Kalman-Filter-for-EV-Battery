...
contrain.volt_HWFET = cat(1,contrain.B0_volt_HWFET,contrain.B10_volt_HWFET,contrain.B25_volt_HWFET,contrain.B40_volt_HWFET,contrain.B10n_volt_HWFET,contrain.B20n_volt_HWFET);
...
contrain.curr_HWFET = cat(1,contrain.B0_curr_HWFET,contrain.B10_curr_HWFET,contrain.B25_curr_HWFET,contrain.B40_curr_HWFET,contrain.B10n_curr_HWFET,contrain.B20n_curr_HWFET);
...
%norm.volt_HWFET_0 = normalize(smooth.B0_volt_HWFET_golay,"range");
%norm.volt_HWFET_10 = normalize(smooth.B10_volt_HWFET_golay,"range");
%norm.volt_HWFET_25 = normalize(smooth.B25_volt_HWFET_golay,"range");
%norm.volt_HWFET_40 = normalize(smooth.B40_volt_HWFET_golay,"range");
%norm.volt_HWFET_n10 = normalize(smooth.B10n_volt_HWFET_golay,"range");
%norm.volt_HWFET_n20 = normalize(smooth.B20n_volt_HWFET_golay,"range");

%norm.curr_HWFET_0 = normalize(smooth.B0_curr_HWFET_golay,"range");
%norm.curr_HWFET_10 = normalize(smooth.B10_curr_HWFET_golay,"range");
%norm.curr_HWFET_25 = normalize(smooth.B25_curr_HWFET_golay,"range");
%norm.curr_HWFET_40 = normalize(smooth.B40_curr_HWFET_golay,"range");
%norm.curr_HWFET_n10 = normalize(smooth.B10n_curr_HWFET_golay,"range");
%norm.curr_HWFET_n20 = normalize(smooth.B20n_curr_HWFET_golay,"range");

%norm.temp_HWFET_0 = normalize(smooth.B0_temp_HWFET_golay,"range");
%norm.temp_HWFET_10 = normalize(smooth.B10_temp_HWFET_golay,"range");
%norm.temp_HWFET_25 = normalize(smooth.B25_temp_HWFET_golay,"range");
%norm.temp_HWFET_40 = normalize(smooth.B40_temp_HWFET_golay,"range");
%norm.temp_HWFET_n10 = normalize(smooth.B10n_temp_HWFET_golay,"range");
%norm.temp_HWFET_n20 = normalize(smooth.B20n_temp_HWFET_golay,"range");

norm.volt_HWFET_0 = normalize(chop.B0_volt_HWFET,"range");
norm.volt_HWFET_10 = normalize(chop.B10_volt_HWFET,"range");
norm.volt_HWFET_25 = normalize(chop.B25_volt_HWFET,"range");
norm.volt_HWFET_40 = normalize(chop.B40_volt_HWFET,"range");
norm.volt_HWFET_n10 = normalize(chop.B10n_volt_HWFET,"range");
norm.volt_HWFET_n20 = normalize(chop.B20n_volt_HWFET,"range");

norm.curr_HWFET_0 = normalize(chop.B0_curr_HWFET,"range");
norm.curr_HWFET_10 = normalize(chop.B10_curr_HWFET,"range");
norm.curr_HWFET_25 = normalize(chop.B25_curr_HWFET,"range");
norm.curr_HWFET_40 = normalize(chop.B40_curr_HWFET,"range");
norm.curr_HWFET_n10 = normalize(chop.B10n_curr_HWFET,"range");
norm.curr_HWFET_n20 = normalize(chop.B20n_curr_HWFET,"range");

norm.temp_HWFET_0 = normalize(chop.B0_temp_HWFET,"range");
norm.temp_HWFET_10 = normalize(chop.B10_temp_HWFET,"range");
norm.temp_HWFET_25 = normalize(chop.B25_temp_HWFET,"range");
norm.temp_HWFET_40 = normalize(chop.B40_temp_HWFET,"range");
norm.temp_HWFET_n10 = normalize(chop.B10n_temp_HWFET,"range");
norm.temp_HWFET_n20 = normalize(chop.B20n_temp_HWFET,"range");

norm.Ah_HWFET_0 = normalize(chop.B0_Ah_HWFET,"range");
norm.Ah_HWFET_10 = normalize(chop.B10_Ah_HWFET,"range");
norm.Ah_HWFET_25 = normalize(chop.B25_Ah_HWFET,"range");
norm.Ah_HWFET_40 = normalize(chop.B40_Ah_HWFET,"range");
norm.Ah_HWFET_n10 = normalize(chop.B10n_Ah_HWFET,"range");
norm.Ah_HWFET_n20 = normalize(chop.B20n_Ah_HWFET,"range");

norm.Ah_HWFET = normalize(conca.Ah_HWFET,"range");
%norm.volt_HWFET = normalize(conca.volt_HWFET,"range");
%norm.curr_HWFET = normalize(conca.curr_HWFET,"range");
norm.temp_HWFET_0deg = normalize(conca.temp_HWFET_0deg,"range");
norm.temp_HWFET_10deg = normalize(conca.temp_HWFET_10deg,"range");
norm.temp_HWFET_25deg = normalize(conca.temp_HWFET_25deg,"range");
norm.temp_HWFET_40deg = normalize(conca.temp_HWFET_40deg,"range");
norm.temp_HWFET_n10deg = normalize(conca.temp_HWFET_n10deg,"range");
norm.temp_HWFET_n20deg = normalize(conca.temp_HWFET_n20deg,"range");
norm.volt_HWFET = normalize(contrain.volt_HWFET,"range");
norm.curr_HWFET = normalize(contrain.curr_HWFET,"range");